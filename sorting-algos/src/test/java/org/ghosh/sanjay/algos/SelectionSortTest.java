    ...
    extends TestCase
{
    ...
    {		
		...
		new SelectionSort<Integer>(new Integer[] {2, 3, 4, 1, 9, 8, 7, 6, 5}).sort()
		.sorted()));
    }
	
	public void testSelectionSortTestForString()
	{		
		assertTrue( Arrays.asList(new String[]{  "Eight", "Five", "Four", "Nine" ,"One", "Seven", "Six", "Three", "Two"}).equals(
		new SelectionSort<String>(new String[] {"One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine"}).sort()
		.sorted()));		
	}
