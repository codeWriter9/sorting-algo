...
public final class SortingFactories {
	...
	public Sort<Integer> integerSort(SortingAlgo algo, Integer[] array) {
		switch (algo) {
		case INSERTION_SORT:
	...
	public Sort<Long> longSort(SortingAlgo algo, Long[] array) {
		switch (algo) {
		case INSERTION_SORT:
			return new InsertionSort<>(array);
		case MERGE_SORT:
	...
	public <T> Sort<?> sort(SortingAlgo algo, T[] array) {
